 ...
 * @summary
 * @description
 * @see https://wiki.mozilla.org/WebAPI/ArchiveAPI
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=1342361
 */
 ...
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=1313580
 */
 ...
 * @summary
 * @description
 * @see https://hg.mozilla.org/mozilla-central/rev/2f9f8ea4b9c3
 ...
 * DOM Storage API
 * @summary
 * @description Disabling DOM storage is known to cause `TypeError:
 ...
 * @see https://www.w3.org/TR/navigation-timing/#privacy
 * @see https://trac.torproject.org/projects/tor/ticket/16336
 * @see https://www.w3.org/TR/2013/REC-user-timing-20131212/#privacy-security
 */
 ...
 * @summary
 * @description
 * @see https://www.mozilla.org/en-US/firefox/geolocation/
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=689252
 * @see
 */
 ...
 * @summary
 * @description
 * @see https://developer.mozilla.org/en-US/docs/IndexedDB
 * @see https://en.wikipedia.org/wiki/Indexed_Database_API
 * @see https://wiki.mozilla.org/Security/Reviews/Firefox4/IndexedDB_Security_Review
 * @see http://forums.mozillazine.org/viewtopic.php?p=13842047
 * @see https://github.com/pyllyukko/user.js/issues/8
 */
 ...
 * @see https://trac.torproject.org/projects/tor/ticket/13023
 ...
 * @summary
 * @description
 * When enabled, leaks information about the client network/browser
 * connection type via JavaScript (ie WiFi, Cellular, etc).
 * @see https://developer.mozilla.org/en-US/docs/Web/API/Network_Information_API
 * @see https://wicg.github.io/netinfo/#privacy-considerations
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=960426
 * @see https://developer.mozilla.org/en-US/docs/Web/API/Connection/onchange
 * @see https://www.torproject.org/projects/torbrowser/design/#fingerprinting-defenses
 *
 */
 ...
 * @see http://kb.mozillazine.org/Browser.send_pings.require_same_host
 */
 ...
 * @summary
 * @description
 * @see https://trac.torproject.org/projects/tor/ticket/18863
 * @see https://www.mozilla.org/en-US/security/advisories/mfsa2015-97/
 * @see https://developer.mozilla.org/docs/Mozilla/B2G_OS/API/TCPSocket
 */
 ...
 * @see https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorker_API
 * @see https://wiki.mozilla.org/Firefox/Push_Notifications#Service_Workers
 * @see https://nvd.nist.gov/vuln/detail/CVE-2016-1949
 * @see https://nvd.nist.gov/vuln/detail/CVE-2016-2812
 * @see https://nvd.nist.gov/vuln/detail/CVE-2016-5259
 * @see https://nvd.nist.gov/vuln/detail/CVE-2016-5287 (fixed)
 */
 ...
 * @summary
 * @description
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=1288359
 */
 ...
 * @see https://www.contextis.com/resources/blog/webgl-new-dimension-browser-exploitation/
 * @see https://developer.mozilla.org/en-US/docs/Web/API/WebGL_API#WebGL_debugging_and_testing
 * @see https://trac.torproject.org/projects/tor/ticket/18603
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=1171228
...
/**
 * WebNotifications API
 * @summary
 * @description
 * @see https://support.mozilla.org/t5/Firefox/I-can-t-find-Firefox-menu-I-m-trying-to-opt-out-of-Web-Push-and/m-p/1317495#M1006501
 */
 ...
 * @summary
 * @description
 * When WebRTC is enabled, it may leak IP addresses within your network
 * unless otherwise configured to prevent this.  We will leave WebRTC
 * enabled to allow peer-to-peer sites to function, though attempt to
 * prevent leaking internal IP addresses and disable access to screen
 * sharing and audio/video capture.
 * @see https://wiki.mozilla.org/Media/WebRTC/Privacy
 * @see https://github.com/beefproject/beef/wiki/Module%3A-Get-Internal-IP-WebRTC
 * @see https://wiki.mozilla.org/Media/getUserMedia
 * @see https://blog.mozilla.org/futurereleases/2013/01/12/capture-local-camera-and-microphone-streams-with-getusermedia-now-enabled-in-firefox/
 ...
 * @see https://wiki.mozilla.org/HTML5_Speech_API
 ...
 * @see https://www.w3schools.com/html/html5_webworkers.asp
 */
 ...
 * @see https://github.com/pyllyukko/user.js/issues/290#issuecomment-303560851
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=665580
 * @see http://kb.mozillazine.org/Keyword.enabled
 */
 ...
 * @see http://kb.mozillazine.org/Intl.locale.matchOS
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=867501
 * @see https://hg.mozilla.org/mozilla-central/rev/52d635f2b33d
 */
...
/**
 * Mixed-Content
 * @see https://support.mozilla.org/t5/Protect-your-privacy/Mixed-content-blocking-in-Firefox/ta-p/10990
 ...
 * Protocol Handlers
 * @description
 * Disabling nonessential protocols breaks all interaction with custom
 * protocols such as mailto:, irc:, magnet:, etc, and breaks opening
 * third-party mail/messaging/torrent/... clients when clicking on
 * links with these protocols
 * @see http://kb.mozillazine.org/Network.protocol-handler.external-default
 * @see http://kb.mozillazine.org/Network.protocol-handler.warn-external-default
 * @see http://kb.mozillazine.org/Network.protocol-handler.expose.%28protocol%29
 * @see https://news.ycombinator.com/item?id=13047883
 * @see https://bugzilla.mozilla.org/show_bug.cgi?id=167475
 * @see https://github.com/pyllyukko/user.js/pull/285#issuecomment-298124005
 * @see https://news.ycombinator.com/item?id=13044991
 */
 ...
 * @summary
 * @description
 * @see https://trac.torproject.org/projects/tor/ticket/16254
 * @see https://support.mozilla.org/en-US/kb/how-stop-firefox-making-automatic-connections#w_geolocation-for-default-search-engine
 */
